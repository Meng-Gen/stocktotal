...
class SourceManager():
    ...
    def source_listed_co_trading_info(self, stock, period, content):
        import core.source.listed_co_trading_info_source as source
    ...
    def source_historical_prices(self, stock, period):
        ...
        for stock_code in self.__get_stock_codes(stock):
            ...
            if period == 'all':
                ...
                s.source_delta(stock_code, begin_date, end_date)
