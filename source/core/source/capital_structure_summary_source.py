...
class CapitalStructureSummarySource(standardchartered_source.StandardcharteredSource):

    def __init__(self):
        standardchartered_source.StandardcharteredSource.__init__(self)

        self.URL_TEMPLATE = '''http://estockweb.standardchartered.com.tw/z/zc/zcb/zcb_%s.djhtm'''
        self.SOURCE_TYPE = 'capital_structure_summary'
        self.HTML_DIR = '../dataset/capital_structure_summary/html/'
        self.CSV_DIR = '../dataset/capital_structure_summary/csv/'
    ...
    def source_html_to_csv(self, src_dir, dest_dir):
        ...
        for table in content.xpath('//html/body/div/table/tr/td[@width="99%"]/table/tr/td/table'):
